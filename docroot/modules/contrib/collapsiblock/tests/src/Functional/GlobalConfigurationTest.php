...
class GlobalConfigurationTest extends CollapsiblockFunctionalTestBase {
  ...
  public function testGlobalConfigOutput() {
    ...
    $this->assertSession()
      ->responseContains('"collapsiblock":{"active_pages":false,"slide_speed":200,"cookie_lifetime":null,"switcher_enabled":false,"switcher_class":""}');
    ...
    $this->drupalGet('<front>');
    $this->assertSession()
      ->responseContains('"collapsiblock":{"active_pages":true,"slide_speed":200,"cookie_lifetime":null,"switcher_enabled":false,"switcher_class":""}');
    ...
    $this->drupalGet('<front>');
    $this->assertSession()
      ->responseContains('"collapsiblock":{"active_pages":true,"slide_speed":500,"cookie_lifetime":null,"switcher_enabled":false,"switcher_class":""}');
    ...
    $this->drupalGet('<front>');
    $this->assertSession()
      ->responseContains('"collapsiblock":{"active_pages":true,"slide_speed":500,"cookie_lifetime":1,"switcher_enabled":false,"switcher_class":""}');
  }
